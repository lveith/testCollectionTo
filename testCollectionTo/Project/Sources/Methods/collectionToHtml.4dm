...
$srcTxtStart:=$srcTxtStart+"body.collectionToHTML > .header {position: fixed; width: 100%; box-shadow: 1px 0px 5px rgb(0, 0, 20); top: 0; left: 0; border: 0px; background: darkblue; color: white; padding: 10px; font-size: 16px; font-weight: bold;}"
